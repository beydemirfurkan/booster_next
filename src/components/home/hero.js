...
export default function Hero() {
    return (
        <section className="h-screen min-h-screen py-4 hero">
            <Image src="/images/home/hero2.png"
                   className="absolute top-0 left-0 right-0 z-10 w-full object-cover h-screen min-h-screen" width={1920}
                   height={780} alt="Hero Image"></Image>
            <div className="container relative z-10 h-full px-5 mx-auto">
                <div className="flex flex-col justify-center w-full h-full md:w-2/3 xl:w-2/5">
                    <h1 className="pb-3 text-5xl md:text-6xl custom-title">Buy<span> Leauge of Legends & Valorant </span>boosting!
                    </h1>
                    <p className="w-full py-6 md:w-2/3">Get incredible win rates and start gaining RR quicker by playing
                        with our Radiant ELO boosters.</p>
                    <Link
