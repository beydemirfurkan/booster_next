        ...
        <div className="grid w-full grid-cols-12 gap-4 place-items-center">
          ...
          <div className="flex flex-col w-full max-w-md lg:mr-12">
            <p className="pb-2 !text-sm font-semibold uppercase tracking-px">
              ...
              <div className="my-3">
              <Link href='/coaching' className='inline-block px-12 py-3.5 text-sm font-medium text-white transition-all bg-[#0d3bff] rounded-full hover:scale-110 hover:shadow-xl focus:outline-none focus:ring  shadow-[0_10px_60px_-15px_rgba(13,59,255,0.8)]'>Select Boosters</Link>
              </div>
          </div>
