                    ...
                    <div className='col-span-12 lg:col-span-5'>
                        ...
                        <div className='flex flex-col gap-6 py-10'>
                            <div className='flex items-center justify-start gap-4'>
                                ...
                                <Link href='/'
                                      className='bg-[#ffca01] font-bold rounded-3xl px-3 py-2.5 text-black hover:bg-black text-xs transition-all hover:text-[#ffca01]'>Sohbete
                                    Başla</Link>
                            </div>
                            <div className='flex items-center justify-start gap-4'>
                                <Image src='/images/contact/discord.png' width={30} height={30}/>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className='flex flex-col gap-4 px-10 py-10'>
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <input type='text'
                                               className='w-full px-4 py-3 rounded-md bg-[#615269] text-white' {...register('name', {required: true})} />
                                    </div>
                                    <div className='flex flex-col gap-2'>
                                        <label className='!text-white text-sm font-semibold'>E-posta Adresiniz</label>
                                        <input type='email'
                                               className='w-full px-4 py-3 rounded-md bg-[#615269] text-white' {...register('email', {required: true})} />
                                    </div>
                                    <div className='flex flex-col gap-2'>
                                        <label className='!text-white text-sm font-semibold'>Konu</label>
                                        <input type='text'
                                               className='w-full px-4 py-3 rounded-md bg-[#615269] text-white' {...register('subject', {required: true})} />
                                    </div>
                                    <div className='flex flex-col gap-2'>
                                        <label className='!text-white text-sm font-semibold'>Mesajınız</label>
                                        <textarea type='text'
                                                  className='w-full px-4 py-3 rounded-md bg-[#615269] text-white' {...register('message', {required: true})} />
                                    </div>
                                    <div className='flex flex-col gap-2 pt-3'>
                                        <button type='submit'
                                                className='w-[200px] max-w-full font-semibold mx-auto px-4 py-3 rounded-3xl bg-[#ffca01] text-black hover:bg-black text-sm transition-all hover:text-[#ffca01]'>Gönder
                                        </button>
                                    </div>
                                </div>
                            </form>
